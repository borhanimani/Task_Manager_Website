...
for designing frontend, seperating HTML, CSS, JavaScript files for better maintenance tried, so the CSS and JavaScript files and   
all picure used in the pages, all are in the "static" folder in the backend side. Also base file (base HTML, CSS) used for the  
pages' elements and components which are similar to all pages, like navbar, or HTML structure. Also Semantic HTML design tried to  
use in the project.
